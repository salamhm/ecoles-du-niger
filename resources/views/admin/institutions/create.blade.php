                    ...
                    <form action="{{ route('admin.institutions.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link disabled" id="contacts-tab" data-toggle="tab" href="#contacts" role="tab" aria-controls="contacts" aria-selected="false">Contacts</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link disabled" id="images-tab" data-toggle="tab" href="#images" role="tab" aria-controls="images" aria-selected="false">Images</a>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="initials" id="initials" class="form-control @error('initials') is-invalid @enderror" value="{{ old('initials') }}">
                                            @error('initials')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="latitude" name="latitude" id="latitude" class="form-control @error('latitude') is-invalid @enderror" value="{{ old('latitude') }}">
                                            @error('latitude')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="presentation" id="presentation" class="form-control @error('presentation') is-invalid @enderror summernote">{{ old('presentation') }}</textarea>
                                        @error('presentation')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
